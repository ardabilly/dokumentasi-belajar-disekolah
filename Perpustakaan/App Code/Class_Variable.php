...
class Class_Variable 
{
    ...
    function string_Get_ProjectName()
    {
        return "Perpustakaan";
    }

    function string_Set_SystemName($ID)
    {
        $array_SystemName = array(
            "Jalan Raya Unknown km 2 kav 2-4, Desa Bogor Tenggara Kota Bogor Postal, West Java Indonesian Code 123456"
        );

        return $array_SystemName[$ID];
    }
    ...
    {
        $q = date("Y-m-d H:i:s");
        $q = strtotime($q) + (3600 * 6);
        $q = date("Y-m-d H:i:s", $q);
        return $q;
    }
