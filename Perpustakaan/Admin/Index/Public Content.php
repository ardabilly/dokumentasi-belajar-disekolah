...
<div class="left">
    <div class="NewsPlace  animated slideInLeft" style="padding-top:10px; padding-left:10px;">
...
<div class="Right">
    <div class="BookPlace animated BounceIn">
        <div class="TitleContent">
            <span id="q1">The</span>
    ...
    <div class="CommentPlace animated slideInRight" style="padding-top:10px; padding-left:10px;">
        <div class="TitleContent">
            <span id="q1">The</span>
...
<style type="text/css">
    ...
    */
    ...
    {
        float: left; width: 90px; height: 110px;
